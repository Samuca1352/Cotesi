<template lang="">
  <footer class="w-full pt-25 py-14 text-white " style="background-color: #0176ff; ">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <img class="h-20 mx-auto" src="../img/logo.png">
                    ...
                    <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        ...
                        <li><a href="#" class="  hover:text-gray-900">Calendário</a></li>
                        <li><a href="#" class="  hover:text-gray-900">Patrocinadores</a></li>
                    </ul>
